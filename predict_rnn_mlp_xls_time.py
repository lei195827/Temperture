...
if __name__ == '__main__':
    ...
    scaler_time = load('scaler_time.joblib')
    sequence_length = 50
    input_size = 8
    hidden_size = 8
    fc_size = 8
    ...
    # model_gru, device = predict_rnn_xls.load_model_rnn(model_rnn_path='model_gru_time.pth', input_size=input_size+1,
    ...
    # input_tensor_gru_time, output = predict_rnn_xls_time.load_test_data_rnn(test_xls, scaler_time, device, column_xls='columns.xlsx',
    #                                                               sequence_length=sequence_length)
    ...
    gru_out = predict_rnn_xls.predict_temperature_rnn(model_gru, input_tensor_rnn,
                                                      sequence_length=sequence_length,
                                                      input_size=input_size)
    # gru_out = predict_rnn_xls.predict_temperature_rnn(model_gru, input_tensor_gru_time,
    #                                                   sequence_length=sequence_length,
